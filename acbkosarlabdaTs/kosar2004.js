var eredmenyek = ["7up Joventut;Adecco Estudiantes;81;73;Palacio Mun. De Deportes De Badalona;2005-04-03",
...
var kosarazasAdat = ObjektumFeltolto(eredmenyek);
console.log(kosarazasAdat);
//3. feladat:
function RealMadrid(vizsgaltObjektum) {
    var hazai = 0;
    var idegen = 0;
...
function DontetlenKiir(eredmeny) {
    if (eredmeny) {
...
//5. feladat:
function BarcelonaCsapat(vizsgaltObjektum) {
    var nev = "";
    for (var i = 0; i < vizsgaltObjektum.length; i++) {
...
function November2004Kiir(kiirandoEredmenyek) {
...
function Stadionok(vizsgaltObjektum) {
    ...
    for (var i = 0; i < vizsgaltObjektum.length; i++) {
        ...
        if (!szerepelE) {
            var ujStadion = { StadionNeve: vizsgaltObjektum[i].helyszin, MerkozesekSzama: 1 };
...
function StadionokKiir(eredmenyObjektum) {
    console.log("7. feladat:");
    for (var i = 0; i < eredmenyObjektum.length; i++) {
